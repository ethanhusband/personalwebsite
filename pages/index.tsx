...
import mandelbrot5 from "./assets/mandelbrot/mandelbrot5.png";
...
const Home: NextPage = () => {
  ...
  return (
    <div className="w-screen bg-black h-screen cursor-crosshair">
      <Head>
      ...
      <NavBar />
      <div className="h-full bg-black mt-12">
      <Image src={mandelbrot5} layout='intrinsic' quality={100}/>
      </div>
    </div>
  )
}
...
// This is merely used to render the images seen at index page
  ...
  const draw = (cont: any) => {
    ...
    while (m <= width + 1) {
      ...
      if (iteration === max_iteration) {
        ...
        colour = 'rgb(' + iteration + ',' + iteration * 0.5 + ',' + iteration * 3 + ')'
      }
